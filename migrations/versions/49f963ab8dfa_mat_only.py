...
Revision ID: 49f963ab8dfa
Revises: 
Create Date: 2019-07-10 01:12:58.845182
...
def upgrade():
    ...
    sa.Column('paper_path', sa.String(length=128), nullable=True),
    sa.Column('answer_path', sa.String(length=128), nullable=True),
